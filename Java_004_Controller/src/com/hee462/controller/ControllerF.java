...
public class ControllerF {
	/*
	 * 51 ~ 100 가지 랜덤수 1개를 만들고. 이 수가 소수(Prime)가 아닌지 찾기 Prime : 1과 자신 이외의 약수를 갖지 않는 수
	 * 2 ~(자신 -1) 범위의 정수로 각각 나누었을대 나머지가 한번도 0이 아닌수
	 * 
	 * 나머지가 한번이ㅏㄹ도 0이 되면 Prime이 아니다.
	 */
	public static void main(String[] args) {
		...
		for (int index = 2; index < rndNum; index++) {
			if (rndNum % index == 0) {
				...
				//반복문을 수행하며 연산을 실행하는 과정에서 소수가 아님을 판별하면, 더이상 반복문을 진행할 필요가 없음으로 여기서 중단
				//break : for(){} 반복문을 중단할때
