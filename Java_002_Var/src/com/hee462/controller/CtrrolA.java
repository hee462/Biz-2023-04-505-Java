...
public class CtrrolA {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * if (boolean type 변수) { }
		 * 만약 "boolean type 변수" 값이 true이면 { } block 내부의 코드를 실행하라
		 *
		 */
		
		// bEven1의 변수의 값이 true이면?
		if(bEven1) {
		...
		// bEven2 값이 true가 아니면?
		if(!bEven2) {
			System.out.println(num2 + "짝수가 아니야!!");
		}
		/* 
		 * Control keyword
		 ...
		 * 
		 * if() 명령문에서 () 조건이 true 일때는 ~~ 한다. 라고 읽는다.
		 *                 () 조건이 !true 일때는 ~~가 아니다. 라고 읽는다.
		 *                 () 조건이 false 일때는 ~~가 아니라. 라고 읽는다.
		 *                 
		 *
		 */
