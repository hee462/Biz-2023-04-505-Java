...
import com.hee462.classes.module.MyClassA;
...
public class ExecD {
	public static void main(String[] args) {
		...
		/*
		 * String type str 객체를 선하고,
		 * String() 생성자  method를 사용하여
		 * str 객체를 초기화 한다.
		 */
		String str = new String("Republic of Kore");
		/*
	...
	//	Scanner scan = new Scanner(System.in);
		 ...
		 * - 선언되지 않는 변수는 초기화, 저장, 읽기, 쓰기 등이
		 * 일체 허용되지 않는다. 사용할수 없다.
		 * 
		 *  
		 *  객체를 생성자 method를 사용하여 초기화 한다.
		 *  - 객체(변수)를 완전히 사용가능한 상채로 만들기
		 *  - 객체(변수)를 초기화 하지 않으면, 일부기능만 사용할수 있다.
		 *  
