 ...
 * 
 * ClassB 에는 아무런 mathod 도 정의되지 않았음에도
 * ClassA 를 상속받아서 마치 ClassA 의 method(2개 add) 들이
 * 정의 되어 있는 것처럼 사용이 가능하다
 * 
 * 객체지향(OOP)  프로그래밍에서 클래스를 상속받기
 * 기존의 잘 만들어진 클래스 코드가 있으면, 그 클래스 코드를
 * 내가 만든 클래스에서 사용하고 싶을때, 
 * ClassA 는 매우 잘 만들어진 클래스라고 하자
 * ClassB 는 ClassA 의 method 들을 그대로 물려받아 사용할 수 있다.
...
public class ClassB extends ClassA{
	 ...
	 * 필요에 따라  method를 다시 재 정의 하여 사용할 수 있는 기능이다.
	 * 
	 */
	 ...
	 * 일반적으로  toString() 각 class 에서 재정의하여 사용한다.
	 * 
	 */
	@Override
	public String toString() {
		return "나는 원래  toString() mthod 를 재정의 한 것이다.";
	}
