...
public class ExecB {
	public static void main(String[] args) {
		...
		// stDto 객체에 Dot(.) 점 연산자를 사용하여 stNum 변수에 접근하여 0001이라는 문자열
		// "저장하기"
		stDto.stNum = "0001";

		// stDto 객체에 Dot(.) 점 연산자를 사용하여 stNum 변수에 접근하여 0001이라는 문자열을
		// "읽고 값을 복사하기"
		String stNum = stDto.stNum;

		// stDto 객체에 Dot(.) 점 연산자를 사용하여 stNum 변수에 "값을 읽고" console 에 출력하기
