...
public class ArrayA {
	public static void main(String[] args) {
		 ...
		 * 2. 현재 위치에 index 위치의 값과 index +1 ~ 끝까지 와 비교한다.
		 * 3. 비교한 결과에서 큰 값을 오른쪽으로, 작은값을 왼쪽으로 배열 요소의 값을 서로 교환한다
		 * 4. 이 명령을 전체 배열 개수 만큼 반복하면
		 * 5. 배열에 저장된 값이 오름차순으로 정렬된다
		 * 
		 * nums[0] 과 nums[1] ~ nums[4] 까지 순서대로 비교
		 * nums[1]과 nums[2],nums[3],nums[4] 와 순서대로 비교
		 * nums[2],nums[3],nums[4] 와 순서대로 비교
		 * nums[3],nums[4] 와 순서대로 비교
		 * 
