...
public class AccIoDto {
	...
	public AccIoDto(String acNum, String aiDate, String aiTime, String acDiv, int aiInput, int aiOutput) {
		super();
		this.acNum = acNum;
		this.aiDate = aiDate;
		this.aiTime = aiTime;
	...
	public String toString() {
		return "AccIoDto [acNum=" + acNum + ", aiDate=" + aiDate + ", aiTime=" + aiTime + ", acDiv=" + acDiv
