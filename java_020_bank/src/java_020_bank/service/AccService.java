...
public interface AccService {
	 ...
	 * 
	 *  입금인가? -> 금액입력 후 입력내용을 리스트에 추가
	 *  출금인가? -> 금액입력 후 출금 할수있나>(잔액 >출금?) => 출금내용 추가
	 *                                                     아니면 => 거부
	 ...
	 *                                                   
	 */
	public void printAccList(); // 입출금 리스트 출력
	public void saveAccList();  // 계좌데이터 저장
	public void loadAccList();  // 계좌정보 읽기
 }
