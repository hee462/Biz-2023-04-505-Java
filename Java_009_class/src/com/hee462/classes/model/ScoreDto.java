package com.hee462.classes.model;
 ...
 * 한번, 이름,국어,영어, 수학 점수를 저장할 변수를 선언
 * 총점, 평균을 계산하려 return 하는 method를 선언
 */
public class ScoreDto {
	...
	/*
	 * this.변수 현재 클래스에 선언된 변수를 가르킨다.
	 * 
	 * this : 클래스를 객체변수로 선언하면, 객체변수 자체를 가르키는 키워드
	 */
