...
public class StringA {
	public static void main(String[] args) {
		 ...
		 *  primitive  변수는 변수를 선원하는 키워드가 모두 소문자이다.
		 *             이 키워드는 단지 데이터를 저장하는 공간인 변수를 선언하는 용도
		 *             (숫자) 변수의 형(type)을 강제 변환하는 용도로만 사용된다.=> (int) 변수
		 *             
		 *  문자열변수는 primitive type 이 아니다.
		 *               class type 이다.   //? 첫 글자 대문자 시작
		 *  class type 으로 생성된 변수는 여러가지 기능(method)들을 많이 포함하고 있다.
		 *                        
		 * 
		 */
		String str1 ="Korea";
